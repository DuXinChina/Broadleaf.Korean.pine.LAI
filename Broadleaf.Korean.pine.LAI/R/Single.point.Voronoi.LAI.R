...
Single.point.Voronoi.LAI=function (minx, maxx, miny, maxy, boundary,a, b, r) 
{
...
rownum=which.min(distp[nrow(data),])
LAI=background[rownum,-c(3,5)]
LAI=cbind(a,LAI)
colnames(LAI)=c("pointx","pointx","treex","treey","Species","LAI")
LAI
}