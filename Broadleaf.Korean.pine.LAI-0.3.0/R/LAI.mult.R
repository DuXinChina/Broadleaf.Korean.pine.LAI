LAI.mult=function (a, b, r) 
{
  ...
  LAI.single = function(a, b, r) {
    ...
    Broadleaf_LAI = sum(ZD_LAI, KD_LAI, MGL_LAI, SQL_LAI, 
                        HTQ_LAI, HBL_LAI, SMQ_LAI, QKQ_LAI, HKQ_LAI, JSQ_LAI, 
                        NJQ_LAI, BNQ_LAI, CY_LAI, BH_LAI, HH_LAI, FH_LAI, 
                        LYY_LAI, QT_LAI)
    ...
    Species_LAI = c(HS_LAI, LS_LAI, YS_LAI, ZD_LAI, KD_LAI, 
                    ...
                    HKQ_LAI, JSQ_LAI, NJQ_LAI, BNQ_LAI, CY_LAI, BH_LAI, 
                    HH_LAI, FH_LAI, LYY_LAI, QT_LAI)
    Species_LAI = matrix(Species_LAI, 1, )
    colnames(Species_LAI) = c()
  ...
  for (j in 1:nrow(a)) {
    ...
    e[j, ] = cbind(as.matrix(a[j, ]), as.matrix(LAI.single(a[j, 
    ], b, r)$N_B_LAI))
